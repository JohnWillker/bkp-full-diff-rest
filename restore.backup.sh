...
HD_O=/dev/mapper/backup #hd onde estão os arquivos de backup
HD_MTD=/backup #diretório onde será montado o hd de onde estão os backups
DVD_MTD=/media/cdrom/ #dispositivo de mídia existente na máquina
DSTBKP=/backup/restore  #diretório onde o backup será restaurado (diretório deverá ser criado antes)
controle=0
DATA=`date +%x-%k%M%S`
